                ...
                <div class="p-6">
                    ...
                    <div class="space-y-4">
                        <div class="flex justify-between items-center">
                            ...
                            <span class="text-lg font-semibold text-green-600">{{ $attendanceStats['total_masuk'] }}</span>
                        </div>
                        <div class="flex justify-between items-center">
                            <span class="text-sm text-gray-600">Total Pulang</span>
                            <span class="text-lg font-semibold text-blue-600">{{ $attendanceStats['total_pulang'] }}</span>
                        </div>
                        <div class="flex justify-between items-center">
                            <span class="text-sm text-gray-600">Terlambat</span>
                            <span class="text-lg font-semibold text-yellow-600">{{ $attendanceStats['total_terlambat'] }}</span>
                        </div>
                        <div class="flex justify-between items-center">
                            <span class="text-sm text-gray-600">Pulang Awal</span>
                            <span class="text-lg font-semibold text-orange-600">{{ $attendanceStats['total_pulang_awal'] }}</span>
                        </div>
                    </div>
                </div>
            </div>
